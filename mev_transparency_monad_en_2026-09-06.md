...
*Draft v1 for publication — 2026-09-06. Window measured 2026-08-23 → 2026-08-30.*

**Status: ready for review, NOT yet published.** Publication and outreach sequence is
[`fastlane_outreach_playbook_2026-09-06.md`](fastlane_outreach_playbook_2026-09-06.md).
...
- **One price source.** MON/USD is a single on-chain spot reading (Uniswap V3 WMON/USDC) at window
  close. All MON figures are given so you can re-price.
