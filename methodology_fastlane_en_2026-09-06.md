# Methodology — Monad full-chain priority payment measurement (7-day window)
...
| 8 | Window robustness: full pipeline re-run on a window shifted 29.5 minutes | All aggregates within 0.4%, see below |
